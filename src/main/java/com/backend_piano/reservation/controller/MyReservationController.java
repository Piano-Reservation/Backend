...
import com.backend_piano.reservation.service.MyReservationService;
...
public class MyReservationController {
    ...
    public ApiResult<List<MyReservationResponse>> getMyReservations(
        ...
        return ApiResult.ok(myReservationService.getMyReservations(studentDetails, date));
    }
    ...
    public ApiResult<Page<MyReservationResponse>> getMyReservationHistory(
        ...
        return ApiResult.ok(myReservationService.getMyReservationHistory(studentDetails, page, size));
    }
}
